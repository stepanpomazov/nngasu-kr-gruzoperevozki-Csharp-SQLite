        ...
        private void commitbtn_Click(object sender, EventArgs e)
        {
            if (lastnametb.Text != "" || firstnametb.Text!= "" || patronomictb.Text!= "" || adresstb.Text != "" || phonetb.Text != "" || comboBox1.Text != "" )
            {
                if (Regex.IsMatch(phonetb.Text, @"^\+7\d{10}$"))
                {
                    ...
                    {
                        string zapros = "INSERT INTO Sender ('last_name','first_name','patronomic','adress','phone','City_city') VALUES ('" + lastnametb.Text + "','" + firstnametb.Text + "','" + patronomictb.Text + "','" + adresstb.Text + "','" + phonetb.Text + "','" + comboBox1.Text + "');";
                        try
                        {
